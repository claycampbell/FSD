...
export default function UploadProcess() {
  ...
  const fileTypes = [
    { id: "MIC", name: "Market Identifier Codes", format: "XML", description: "Market Identifier Codes reference data" },
    { id: "LEI", name: "Legal Entity Identifiers", format: "XML", description: "Legal Entity Identifiers reference data" },
  ...
  const recentUploads = [
    { id: 1, filename: "MIC_20240307.xml", fileType: "MIC", uploadDate: "2024-03-07 10:15", status: "Valid", records: 345, errors: 0 },
    { id: 2, filename: "LEI_20240307.xml", fileType: "LEI", uploadDate: "2024-03-07 09:45", status: "Valid", records: 1250, errors: 0 },
    { id: 3, filename: "CURRENCY_20240307.xml", fileType: "CURRENCY", uploadDate: "2024-03-07 09:30", status: "Warning", records: 178, errors: 3 },
    { id: 4, filename: "INSTRUMENT_20240307.xml", fileType: "INSTRUMENT", uploadDate: "2024-03-07 08:15", status: "Error", records: 5670, errors: 42 },
    { id: 5, filename: "RCA_20240306.xml", fileType: "RCA", uploadDate: "2024-03-06 16:45", status: "Valid", records: 87, errors: 0 },
  ]
        ...
        <TabsContent value="upload" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select file type and upload XML file for processing
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="rounded-md border p-3 bg-muted/40">
                    ...
                    <div className="mt-2">
                      <Button variant="outline" size="sm">Download Schema</Button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {uploadComplete && validationErrors.length > 0 && (
                <Collapsible className="w-full">
                  <Alert className={validationErrors.some(e => !e.severity) ? "bg-red-50 border-red-200" : "bg-amber-50 border-amber-200"}>
                    {validationErrors.some(e => !e.severity) ? (
                      <AlertTriangle className="h-4 w-4 text-red-600" />
                    ) : (
                      <Info className="h-4 w-4 text-amber-600" />
                    )}
                    <AlertTitle className={validationErrors.some(e => !e.severity) ? "text-red-800" : "text-amber-800"}>
                      Validation {validationErrors.some(e => !e.severity) ? "Errors" : "Warnings"}
                    </AlertTitle>
                    <AlertDescription className={validationErrors.some(e => !e.severity) ? "text-red-700" : "text-amber-700"}>
                      {validationErrors.some(e => !e.severity) 
            ...
            <CardFooter className="flex justify-between">
              ...
              <Button disabled={isUploading || !uploadComplete}>
                Process File
              </Button>
            </CardFooter>
          </Card>
        ...
        <TabsContent value="validation" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Reference data validation rules and schemas
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <Collapsible key={type.id} className="w-full border rounded-md p-4">
                    ...
                    <CollapsibleContent className="mt-4 space-y-4">
                      ...
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm">Download Schema</Button>
                        <Button variant="outline" size="sm">View Validation Rules</Button>
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                ))}
